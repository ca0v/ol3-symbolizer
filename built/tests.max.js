...
define("tests/common", ["require", "exports", "ol3-symbolizer/common/assign", "node_modules/ol3-fun/index", "node_modules/ol3-fun/tests/base"], function (require, exports, assign_1, index_1, base_1) {
    Object.defineProperty(exports, "__esModule", { value: true });
    base_1.describe("assign tests", function () {
        base_1.it("assign empty", function () {
        });
        base_1.it("assign number", function () {
            var target = {};
            assign_1.assign(target, "a", 100);
            base_1.should(target.a === 100, "");
        });
        base_1.it("assign object", function () {
            var target = {};
            assign_1.assign(target, "a", { a: 100 });
            base_1.should(target.a.a === 100, "");
        });
    });
    base_1.describe("defaults tests", function () {
        base_1.it("defaults number", function () {
            base_1.should(index_1.defaults({}, { a: 100 }).a === 100, "");
            base_1.should(index_1.defaults(index_1.defaults({}, { a: 100 }), { a: 200 }).a === 100, "");
            var a = index_1.defaults({}, { a: 1 });
            base_1.should(a === index_1.defaults(a, { a: 2 }), "");
        });
    });
    base_1.describe("mixin tests", function () {
        base_1.it("mixin number", function () {
            base_1.should(index_1.mixin({}, { a: 100 }).a === 100, "");
            base_1.should(index_1.mixin(index_1.mixin({}, { a: 100 }), { a: 200 }).a === 200, "");
            var a = index_1.mixin({}, { a: 1 });
            base_1.should(a === index_1.mixin(a, { a: 2 }), "");
        });
    });
    base_1.describe("test accessing openlayers using amd", function () {
        base_1.it("log ol.style.Style", function () {
    ...
    var StyleConverter = (function () {
        ...
        StyleConverter.prototype.serializeStyle = function (style) {
            ...
            if (typeof style === "number")
                throw style;
            if (style.getColor)
                index_2.mixin(s, this.serializeColor(style.getColor()));
            if (style.getImage)
        ...
        StyleConverter.prototype.deserializeStar = function (json) {
            ...
            index_2.doif(json.rotation, function (v) { return image.setRotation(v); });
            index_2.doif(json.opacity, function (v) { return image.setOpacity(v); });
            return image;
        };
        ...
        StyleConverter.prototype.deserializeStroke = function (json) {
            ...
            index_2.doif(json.color, function (v) { return stroke.setColor(v); });
            index_2.doif(json.lineCap, function (v) { return stroke.setLineCap(v); });
            index_2.doif(json.lineDash, function (v) { return stroke.setLineDash(v); });
            index_2.doif(json.lineJoin, function (v) { return stroke.setLineJoin(v); });
            index_2.doif(json.miterLimit, function (v) { return stroke.setMiterLimit(v); });
            index_2.doif(json.width, function (v) { return stroke.setWidth(v); });
            return stroke;
        };
...
define("tests/ol3-symbolizer", ["require", "exports", "ol3-symbolizer/styles/stroke/linedash", "node_modules/ol3-fun/tests/base", "ol3-symbolizer/format/ol3-symbolizer"], function (require, exports, Dashes, base_2, ol3_symbolizer_1) {
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("tests/ags-symbolizer", ["require", "exports", "node_modules/ol3-fun/tests/base", "ol3-symbolizer/format/ags-symbolizer", "ol3-symbolizer/format/ol3-symbolizer"], function (require, exports, base_3, ags_symbolizer_1, ol3_symbolizer_2) {
    Object.defineProperty(exports, "__esModule", { value: true });
