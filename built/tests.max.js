...
define("tests/data/tile1", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.mockDataZones = {
...
define("tests/spec/ags-source", ["require", "exports", "openlayers", "jquery", "node_modules/ol3-fun/tests/base", "ol3-symbolizer/ags/ags-source", "tests/data/tile1", "node_modules/ol3-fun/ol3-fun/common"], function (require, exports, ol, $, base_16, ags_source_1, tile1_1, common_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    define("/mock/arcgis/rest/services/mockServiceName/FeatureServer/3?f=pjson&callback=define", function () {
        return {
    ...
    function mock(args) {
        ...
        $.ajax = function (url, settings) {
            ...
            var response = args.respond({ url: url, settings: settings });
            var d = $.Deferred();
            d.resolve(response);
        ...
        base_16.it("ArcGisVectorSourceFactory", function (done) {
            ...
            ags_source_1.ArcGisVectorSourceFactory.create({
                ...
                layers.forEach(function (l) {
                    ...
                    source.on("change", common_9.debounce(function () {
